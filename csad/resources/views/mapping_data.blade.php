...
<div class="row">
	<div class="col-9">
		<form method="POST" action="/update" enctype="mltipart/form-data"  >
					...
					<table>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<label>Default</label>&emsp;
									<input type="date" name="default5" value="{{ $field5->default}}" id="default5">
								</td>
							</tr>
							@endforeach
							...
							<tr>
								<td>
									<!-- <input type="text" name="csfield6" value="{{ $field6->cscart_fields}}" > -->
							...
							<tr>
								...
								<td>
									<label>Default</label>&emsp;
									<input type="date" name="default7" value="{{ $field7->default}}" id="default7">
								</td>
							</tr>
							@endforeach
							...
							<tr>
								...
								<td>
									<input type="text" name="adamsfield18" id="adamsfield18" value="{{ $field18->adams_fields }}" readonly>
								</td>
								<td>
									<label>Default</label>&emsp;
			...
			<div class="">
				...
				<input type="hidden" name="" value="{{ $template_field->id}}" name="template_id">
				<input type="hidden" name="template_name" value="{{ $template_field->template_name}}">
				@endforeach
			</div>
			<!-- <a href="/editfield/{{ $template_field->id }}" class="btn btn-primary"> Edit Fields</a>&emsp;&emsp;&emsp; -->
			<a href="/setfields" class="btn btn-primary">Set Fields</a>&emsp;&emsp;&emsp;
	...
	<div class="col-3">
		<form action="" method="POST" enctype="mltipart/form-data" >
			@csrf
			<fieldset>
